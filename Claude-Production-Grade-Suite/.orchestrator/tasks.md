...
| T3a | Software Engineer — Backend services | T2 | pending |
| T3b | Frontend Engineer — Pages/UI | T2 | pending |
| T4a | DevOps — Dockerfiles + CI skeleton | T2 | pending |
| T5a | QA Engineer — Test plan | T2 | pending |
| T6a | Security Engineer — STRIDE threat model | T2 | pending |
| T6b | Code Reviewer — conformance checklist | T2 | pending |
| T9a | SRE — SLO definitions | T2 | pending |
